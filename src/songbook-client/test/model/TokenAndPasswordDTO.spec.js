...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TokenAndPasswordDTO', function() {
      beforeEach(function() {
        instance = new SongbookApi.TokenAndPasswordDTO();
      });

      it('should create an instance of TokenAndPasswordDTO', function() {
        // TODO: update the code to test TokenAndPasswordDTO
        expect(instance).to.be.a(SongbookApi.TokenAndPasswordDTO);
      });
